...
public class SqlHelper {
	public static void insertInfo(Object[] obj) throws SQLException{
			...
			String sql="insert into tunchang(titleurl,doc,txt,syh,ztfl,publication,zpfl,title,wh,date,topic) values(?,?,?,?,?,?,?,?,?,?,?)";
			//String sql="insert into qiongzhong(titleurl,syh,ztfl,publication,zpfl,title,wh,date,topic,doc,txt) values(?,?,?,?,?,?,?,?,?,?,?)";
