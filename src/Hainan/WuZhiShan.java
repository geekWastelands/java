...
public class WuZhiShan {
	...
	public static void main(String[] args) {
		...
		for(int i=0;i<num.size();i++){
			...
			while(page<=20){
				String url=null;
				//http://xxgk.hainan.gov.cn/wzsxxgk/wsj/24880/24886/list.htm
				if(page==0)
					url="http://xxgk.hainan.gov.cn/wzsxxgk/wsj/24880/"+num.get(i)+"/list.htm";
				else
					url="http://xxgk.hainan.gov.cn/wzsxxgk/wsj/24880/"+num.get(i)+"/list_"+page+".htm";
				page++;
				Document doc1=null;
				for(int j=0;j<10;j++){
					try {
