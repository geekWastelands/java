...
public class ZhuMaDian {

	public static void main(String[] args) {
		// TODO Auto-generated method stub
		HashMap<String, Integer>L = new HashMap<String, Integer>();
		//			http://www.zmdwsj.gov.cn/pub/news/annc/2.html
		L.put("http://www.zmdwsj.gov.cn/pub/news/annc/", 4);
		L.put("http://www.zmdwsj.gov.cn/pub/news/working/", 4);
		...
		for(Entry<String, Integer> entry : L.entrySet()){
			...
			while(cnt<=entry.getValue()){
				...
				for (Element list : Lists) {
					...
					String title=doc2.select("div.article h2").text();
					title=title.substring(0,title.indexOf("·¢")-1);
					System.out.println("title = "+ title);
					String txt=doc2.select("div.article").text();
					String doc=doc2.select("div.article").html();
